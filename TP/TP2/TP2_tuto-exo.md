...
1. Connectez-vous  au site Web [NCBI BLAST](https://blast.ncbi.nlm.nih.gov/) et choisissez **blastn** (attention, **ne confondez pas** avec tblastn). Le logiciel **blastn** la version de BLAST qui compare une séquence requête nucléique avec des séquences nucléiques. 
